...
export default function NotifyMe() {
  ...
  return (
    <section className="fixed top-0 left-0 h-screen w-screen z-[5000] flex flex-col items-center justify-center text-white overflow-hidden">
      {/* Background Image */}
      <Image
        src="/coming-soon.png"
      ...
      <header className="fixed top-0 left-0 w-full py-5 flex items-center justify-between z-[5100] bg-transparent px-10">
        <span className="allison text-3xl text-white">Adoram Tom</span>
      ...
      <div className="w-full flex flex-col justify-center gap-20">
        ...
        <div className="z-50 w-full flex flex-col gap-10 xl:flex-row justify-between px-10 text-lg md:text-2xl font-light">
          <div className="flex flex-col justify-start items-start">
            <p data-aos="fade-right" className="text-xl text-white mb-10">
          ...
          <p
            data-aos="fade-left"
            className="mt-10 lg:mt-0 max-w-2xl text-right text-white"
          >
        ...
        >
          <span className="text-white text-lg mb-10">
          ...
          <input
            ...
            required
            className="w-full mb-5 flex-1 p-5 text-xl text-white outline-none border-b border-white text-center bg-transparent placeholder-gray-300"
          />

          <button
            type="submit"
            className="michroma px-12 py-3 bg-white text-gray-900 font-medium rounded-full hover:bg-gray-200 transition cursor-pointer"
          >
            Notify Me
          </button>
        </form>
