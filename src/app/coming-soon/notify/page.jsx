...
export default function NotifyMe() {
  ...
  return (
    <div className="fixed top-0 left-0 h-screen w-screen z-[5000] overflow-hidden">
      {/* ✅ Background Image stays fixed */}
      <Image
        src="/coming-soon.png"
        alt="Notify Me Background"
        fill
        className="object-cover object-center -z-10 fixed"
        priority
        unoptimized
      />
      ...
      {/* ✅ Scrollable child */}
      <section className="relative h-full w-full overflow-y-auto flex flex-col items-center justify-start text-white scroll-smooth">
        {/* ✅ Fixed Header */}
        ...
        {/* ✅ Scrollable Content */}
        <div className="w-full flex flex-col justify-center gap-20 pt-40 pb-40">
          {/* Captions */}
          <div className="z-50 w-full flex flex-col gap-10 xl:flex-row justify-between px-10 text-lg md:text-2xl font-light">
            ...
            >
              ...
              case studies, including projects in health-tech, product design,
              and user experience research. <br /> Stay tuned — great things are
              coming soon.
            </p>
          </div>

          {/* ✅ Form section scrolls naturally */}
          <form
            data-aos="zoom-in"
          ...
          >
            <span className="text-black text-lg mb-10 text-center">
