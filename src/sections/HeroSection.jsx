...
export default function HeroSection() {
    ...
    return (
        <section className="pt-30 pb-10 lg:pb-30 relative h-full lg:h-[110dvh] overflow-hidden px-5 lg:px-10 w-full bg-cover bg-center bg-fixed grid grid-cols-1 lg:grid-cols-3"
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center gap-10 lg:gap-5 z-10">
                ...
                <CustomButton variant="white" href={"/projects"}>View my works</CustomButton>
            </div>
        </section>
    )
}